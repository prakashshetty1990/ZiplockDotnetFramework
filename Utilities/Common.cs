...
namespace SWAUTCSharpFramework
{
    ...
    public class Common
    {
        ...
        {
            string Reportdate = System.DateTime.Now.ToString(@"yyyy-MM-dd hh:mm:ss tt");
       ...
       //To change the log file path,by deault it writes to a specific file location
        ...
        public static string GetConfigProperty(string data)
        {
            ...
            string con = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\ZipLockDotnetFramework\TestData\TestConfiguration.xls;" +
            ...
            using (OleDbConnection connection = new OleDbConnection(con))
            {
                ...
                using (OleDbDataReader dr = command.ExecuteReader())
                {
                    ...
                    {
                        var row1Col0 = dr[1];
                        string Exceldata = dr[1].ToString();
